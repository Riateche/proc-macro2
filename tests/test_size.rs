...
fn test_proc_macro2_fallback_size_with_locations() {
    assert_eq!(mem::size_of::<proc_macro2_send::Span>(), 16);
    assert_eq!(mem::size_of::<Option<proc_macro2_send::Span>>(), 16);
    assert_eq!(mem::size_of::<proc_macro2_send::Group>(), 32);
    assert_eq!(mem::size_of::<proc_macro2_send::Ident>(), 40);
    assert_eq!(mem::size_of::<proc_macro2_send::Punct>(), 24);
    assert_eq!(mem::size_of::<proc_macro2_send::Literal>(), 40);
    assert_eq!(mem::size_of::<proc_macro2_send::TokenStream>(), 8);
}
